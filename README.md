...
4. 在浏览器中访问 http://localhost:5137 即可体验。
(注意：需在 public 文件夹下配置 body_front.png 和 body_back.png 底图文件以完整体验翻转功能)

---

## 🎯 Online Demo | 在线演示
目前已完成前端开发，可直接在线体验 Demo：
🔗 https://pain-scape.vercel.app/
仅实现前端交互功能，欢迎大家体验并提出宝贵意见！
...
感谢所有参与本研究问卷填写与深度访谈的女性。是你们勇敢分享的痛觉记忆，赋予了这些代码与图形以血肉与灵魂。
